...
class SM_Point_LineWidthMeasureHandler:
	public MouseHandler
{
private:
...
public:
	...
	SM_Point_LineWidthMeasureHandler(); //default constructor..
	~SM_Point_LineWidthMeasureHandler(); //destructor... clear the memory related..!
