...
class SM_Line_LineWidthMeasureHandler:
	public MouseHandler
{
private:
...
public:
	...
	SM_Line_LineWidthMeasureHandler(); //default constructor..
	~SM_Line_LineWidthMeasureHandler(); //destructor... clear the memory related..!
