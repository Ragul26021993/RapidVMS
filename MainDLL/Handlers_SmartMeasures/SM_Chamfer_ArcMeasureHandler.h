...
class SM_Chamfer_ArcMeasureHandler:
	public MouseHandler
{
private:
...
public:
	SM_Chamfer_ArcMeasureHandler(bool InitialiseShape = true, bool tangentialarc = false); //default constructor..
	~SM_Chamfer_ArcMeasureHandler(); //destructor... clear the memory related..!
